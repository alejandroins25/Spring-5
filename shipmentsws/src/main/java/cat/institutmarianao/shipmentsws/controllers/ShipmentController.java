...
public class ShipmentController {
	...
	public List<ShipmentDto> findAll(@RequestParam(value = "status", required = false) Status status,
		...
		List<Shipment> shipments = shipmentService.findAll(status, receivedBy, courierAssigned, category, from, to);
	...
	public List<ShipmentDto> findAllPending(@RequestParam(value = "receivedBy", required = false) String receivedBy,
		...
		List<Shipment> shipments = shipmentService.findAllPending( receivedBy, courierAssigned, category, from, to);
	...
	public List<ShipmentDto> findAllInProcess(@RequestParam(value = "receivedBy", required = false) String receivedBy,
		...
		List<Shipment> shipments = shipmentService.findAllInProcess( receivedBy, courierAssigned, category, from, to);
	...
	public ShipmentDto findById(@PathVariable("shipmentId") @Positive Long shipmentId) {
		...
		Shipment opShipment = shipmentService.getById(shipmentId);
		return conversionService.convert(opShipment, ShipmentDto.class);
	}
